  ...
  return (
    <div className="aboutmePage">
      ...
      <div className="aboutmePage__paper">
        <article className="aboutmePage__paper--article article">
          <div className="article__div1">
          <div className="article__div1--img imgbg">
            <img className="imgbg__img" src={photo}></img>
          </div>
          <div className=" article__div1--text text">
          ...
          <div className="article__div2 text">
            <p className="text__p">
